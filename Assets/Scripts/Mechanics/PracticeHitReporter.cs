...
public class PracticeHitReporter : MonoBehaviour
{
    public enum PracticeSide
    {
        Player,
        Enemy
    }
    ...
    [Header("Setup")]
    [SerializeField] private PracticeRoundManager _manager;
    [SerializeField] private PracticeSide _side;
    ...
    {
        if (_manager == null)
            _manager = FindFirstObjectByType<PracticeRoundManager>();
    }
